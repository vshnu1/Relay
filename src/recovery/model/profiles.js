...
export const PROFILES = {
  ...
  sepsisWatch: {
    ...
    recorded: ["oxygen", "sleep", "walkingHr", "temperature"],
    questions: ["fever", "pain", "wound", "fatigue", "medicine", "activity"],
  },
  respiratoryInfection: {
    ...
    recorded: ["sleep", "deepSleep", "walkingHr", "temperature"],
    questions: [
      "breathing",
      "cough",
      "fever",
  ...
  pulmonaryEmbolism: {
    ...
    recorded: ["hrv", "sleep"],
    questions: ["breathing", "chest", "dizziness", "medicine", "activity"],
  },
  sleepApnoea: {
    ...
    questions: ["sleepiness", "breathing", "fatigue", "medicine", "activity"],
  },
  postpartum: {
    ...
    recorded: ["hrv", "oxygen", "temperature"],
    questions: ["bleeding", "headache", "fever", "pain", "medicine"],
  },
  afib: {
...
export const QUESTION_SIGNAL_MAP = {
  ...
  asthma: {
    ...
    cough: ["breathing", "oxygen"],
    mucus: ["breathing"],
    inhaler: ["breathing", "oxygen"],
    medicine: [],
    activity: ["walkingHr"],
  },
  pulmonaryEmbolism: {
    breathing: ["breathing", "oxygen"],
    chest: ["breathing", "restingHr"],
    dizziness: ["restingHr", "oxygen"],
    medicine: [],
    activity: ["walkingHr", "restingHr"],
  },
  sleepApnoea: {
    sleepiness: ["sleep", "deepSleep"],
    breathing: ["breathing", "oxygen"],
    fatigue: ["deepSleep", "sleep"],
    medicine: [],
    activity: ["walkingHr"],
  },
  postpartum: {
